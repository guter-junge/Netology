...
with psycopg2.connect(database='personal_info', user='postgres', password=password) as conn:
    # create_db('personal_info', 'postgres', password)
    # create_tables('personal_info', 'postgres', password)
    # add_client('personal_info', 'postgres', password)
    # add_phone_number('personal_info', 'postgres', password)
    # update_client_info('personal_info', 'postgres', password)
    # delete_phone_number('personal_info', 'postgres', password)
    # delete_client('personal_info', 'postgres', password)
    # find_client('personal_info', 'postgres', password)
